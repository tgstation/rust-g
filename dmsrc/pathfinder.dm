 ...
 */
#define rustg_register_nodes_astar(json) RGCALL(RUST_G, "register_nodes_astar")(json)
 ...
 */
#define rustg_add_node_astar(json) RGCALL(RUST_G, "add_node_astar")(json)

/**²
 * Remove every link to the node with unique_id. Replace that node by null
 */
#define rustg_remove_node_astart(unique_id) RGCALL(RUST_G, "remove_node_astar")(unique_id)

/**
 * Compute the shortest path between start_node and goal_node using A*. Heuristic used is simple geometric distance
 */
#define rustg_generate_path_astar(start_node_id, goal_node_id) RGCALL(RUST_G, "generate_path_astar")(start_node_id, goal_node_id)
