 ...
 */
#define rustg_setup_acreplace(key, patterns, replacements) RGCALL(RUST_G, "setup_acreplace")(key, json_encode(patterns), json_encode(replacements))
 ...
 * * replacements - Default replacements for this automaton, used with rustg_acreplace
 */
#define rustg_setup_acreplace_with_options(key, options, patterns, replacements) RGCALL(RUST_G, "setup_acreplace")(key, json_encode(options), json_encode(patterns), json_encode(replacements))
 ...
 */
#define rustg_acreplace(key, text) RGCALL(RUST_G, "acreplace")(key, text)
 ...
 */
#define rustg_acreplace_with_replacements(key, text, replacements) RGCALL(RUST_G, "acreplace_with_replacements")(key, text, json_encode(replacements))
